...
from py_code.data.asset_file_data_types import Gltf2Data
from py_code.io.file.gltf2.com.gltf2_io import Buffer, BufferView
from py_code.io.file.gltf2.exp.gltf2_io_binary_data import BinaryData as ExpBinaryData
from py_code.io.file.gltf2.exp.gltf2_io_buffer import Buffer as ExpBuffer
from py_code.io.file.gltf2.utils import uri_to_path


class GlTF2Exporter:
    """Class to handle glTF2 export"""

    def __init__(self, export_dir: str, filename: str, is_glb: bool, filename_ext: str):
